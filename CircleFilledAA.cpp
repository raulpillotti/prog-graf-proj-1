...
// void CircleFilledAA::normalize(float metersX, float metersY, int screenWidth,
//                                int screenHeight) {
//   // Normaliza normalmente
//   center.normalize(metersX, metersY, screenWidth, screenHeight);

//   // Aplica flip no eixo Y diretamente aqui
//   center.screen_y = screenHeight - center.screen_y;

//   // Calcula o raio em pixels
//   if (metersX > 0 && metersY > 0) {
//     float scaleX = screenWidth / metersX;
//     float scaleY = screenHeight / metersY;
//     screen_radius = static_cast<int>(world_radius * (scaleX + scaleY) / 2.0f);
